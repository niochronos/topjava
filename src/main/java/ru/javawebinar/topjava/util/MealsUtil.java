...
public class MealsUtil {
    ...
    public static List<MealWithExceed> createWitnExceeded(Collection<Meal> meals, int caloriesPerDay) {
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static MealWithExceed createWitnExceeded(List<Meal> meals, Meal meal) {
        Map<LocalDate, Integer> caloriesSumByDate = meals.stream()
                .collect(Collectors.groupingBy(Meal::getDate, Collectors.summingInt(Meal::getCalories)));

        return createWithExceed(meal, caloriesSumByDate.get(meal.getDate()) > DEFAULT_CALORIES_PER_DAY);
    }
}